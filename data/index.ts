...
export const approaches = [
  {
    ...
    description:
      "We begin by understanding your project goals, target audience, and desired features. Together, we'll map out a strategy and plan the site structure and functionality."
  },
  {
    id: 2,
    title: 'Design & Development',
    description:
      "Once the plan is clear, I create the design and begin coding, turning the vision into a functional, visually appealing website or application. You'll receive updates at key milestones."
  },
  {
    id: 3,
